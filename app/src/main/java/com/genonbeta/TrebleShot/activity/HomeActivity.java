...
public class HomeActivity
        extends Activity
        implements NavigationView.OnNavigationItemSelectedListener, PowerfulActionModeSupport, MapFragment.OnFragmentInteractionListener
{
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
        ...
        } else if (R.id.menu_activity_main_profile == mChosenMenuItemId) {
            startActivity(new Intent(this, PofileActivity.class));
        } else if (R.id.menu_activity_main_wallet == mChosenMenuItemId) {
            ...
            new ShareAppDialog(HomeActivity.this)
                    .show();
        } else if (R.id.menu_activity_main_shareDocAsContributor == mChosenMenuItemId) {
        ...
        } else if (R.id.menu_order_history == mChosenMenuItemId) {
            toggleTrustZone();
        }
